		...
		if (i.settings.showFilterInputs) {
			...
			e.each(function(e, t) {
				...
				(t.text.match(o) || (i.settings.filterOnValues && n.attr('value').match(o))) &&
					((s = !1), i.elements['select' + l].append(n.clone(!0).prop('selected', n.data('_selected')))),
	...
	function g(n) {
		n.elements.form.submit(function(e) {
			n.elements.filterInput1.is(':focus')
				...
				: n.elements.filterInput2.is(':focus') && (e.preventDefault(), n.elements.filterInput2.focusout());
		}),
	...
	(l.prototype = {
		...
		setNonSelectedFilter: function(e, t) {
			if (this.settings.showFilterInputs)
				return (
					(this.settings.nonSelectedFilter = e), this.elements.filterInput1.val(e), t && m(this), this.element
				);
		},
		setSelectedFilter: function(e, t) {
			if (this.settings.showFilterInputs)
				return (
					(this.settings.selectedFilter = e), this.elements.filterInput2.val(e), t && m(this), this.element
				);
		},
			...
			return void 0 === n || 'object' == typeof n
				? this.each(function() {
						a(this).is('select')
							...
							: a(this).find('select').each(function(e, t) {
