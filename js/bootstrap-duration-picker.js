(function iife($) {
  ...
  $.DurationPicker = function DurationPicker(mainElement, options) {
    ...
    function durationPickerChanged() {
      days = 0;//parseInt(inputs.days.val(), 10) || 0;
      hours = (parseInt(inputs.hours.val(), 10) || 0)>23?23:parseInt(inputs.hours.val(), 10);
      minutes = (parseInt(inputs.minutes.val(), 10) || 0)>59?59:parseInt(inputs.minutes.val(), 10);
      seconds = (parseInt(inputs.seconds.val(), 10) || 0)>59?59:parseInt(inputs.seconds.val(), 10);
      updateUI();
    }
